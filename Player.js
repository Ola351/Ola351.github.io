...
class Player {
    ...
    GetImageToUseBasedOnState() { // Arrumar aqui
        if (this.isClone) {
            this.rightHeld = this.state.rightHeld;
            this.leftHeld = this.state.leftHeld;
            this.currentSpeed.y = this.state.currentSpeedY;
            this.jumpHeld = this.state.jumpHeld;
            this.isOnGround = this.state.isOnGround;
            this.hasFallen = this.state.hasFallen;
            this.hasBumped = this.state.hasBumped;
